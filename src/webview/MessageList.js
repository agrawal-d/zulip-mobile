...
import getOnShouldStartLoadWithRequest, { assetsPath } from './getOnShouldStartLoadWithRequest';
...
class MessageList extends Component<Props> {
  ...
  render() {
    ...
    const onShouldStartLoadWithRequest = getOnShouldStartLoadWithRequest(baseUrl);
